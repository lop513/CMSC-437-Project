...
public class Solitaire : MonoBehaviour
{
    ...
    public void PlayCards()
    {
        ...
        FindObjectOfType<UserInput>().slot1 = this.gameObject;

        // This would be where we implement two sortDeckIntoTrips, one for draw 1 and one for draw 3
        SortDeckIntoTrips();
    ...
    IEnumerator SolitaireDeal()
    {
        for (int i = 0; i < 7; i++)
        {
            ...
            foreach (string card in bottoms[i])
            {
                ...
                Vector3 scaleTmp = newCard.transform.localScale;
                scaleTmp.x /= bottomPos[i].transform.localScale.x;
                scaleTmp.y /= bottomPos[i].transform.localScale.y;
                scaleTmp.z /= bottomPos[i].transform.localScale.z;
                newCard.transform.parent = bottomPos[i].transform;
                newCard.transform.localScale = scaleTmp;
    ...
    public void SortDeckIntoTrips()
    {
        ...
        else if (sceneName == "Draw 1 Scene")
        {
            trips = deck.Count / 1;
    ...
    public void DealFromDeck()
    {
        ...
        if(deckLocation < trips)
        {
            ...
            foreach(string card in deckTrips[deckLocation])
            {
                ...
                Vector3 scaleTmp = newTopCard.transform.localScale;
                scaleTmp.x /= deckButton.transform.localScale.x;
                scaleTmp.y /= deckButton.transform.localScale.y;
                scaleTmp.z /= deckButton.transform.localScale.z;
                newTopCard.transform.parent = deckButton.transform;
                newTopCard.transform.localScale = scaleTmp;
